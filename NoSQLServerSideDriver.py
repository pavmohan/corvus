...
class c3(webapp2.RequestHandler):
  def post(self): 
    ...
    cheeseObj.put()
    self.response.write(json.dumps(cheeseObj.to_dict()))
...
class s3(webapp2.RequestHandler):
  def post(self): 
    ...
    cheeseShopObj.ZipCode=newCheeseShop['Phone']
...
class r3(webapp2.RequestHandler):
  def post(self): 
    ...
    revObj.put()
    self.response.write(json.dumps(revObj.to_dict()))
